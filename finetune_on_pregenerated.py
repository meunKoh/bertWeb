...
def main():
    ...
    parser.add_argument("--sp_model_path",
                        default=None,
                        type=str,
                        required=True,
                        help="Word-piece model path")
    ...
    tokenizer = BertTokenizer.from_pretrained(args.bert_model, do_lower_case=args.do_lower_case, sp_model_path=args.sp_model_path)
    ...
    model = BertForPreTraining.from_pretrained(args.bert_model, from_scratch=True)
